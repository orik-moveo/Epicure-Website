...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    changes: Schema.Attribute.Component<'dish.changes-option', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    restaurant: Schema.Attribute.Relation<
      ...
      'api::restaurant.restaurant'
    >;
    sides: Schema.Attribute.Component<'dish.side-option', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'homepage.about-section', false>;
    chefOfWeek: Schema.Attribute.Component<
      'homepage.chef-of-week-section',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'homepage.hero-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    popularDishes: Schema.Attribute.Component<
      'homepage.popular-dishes-section',
      false
    >;
    popularRestaurants: Schema.Attribute.Component<
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    openingHours: Schema.Attribute.Component<'restaurant.opening-hours', true>;
    publishedAt: Schema.Attribute.DateTime;
